...
object Add00Spec extends Properties("Add00") with NodeSpecBase {
  ...
  property("var0 + var0 reverse node0") = forAll(genV0(), genN0()) { (a: Var0, b: N0) =>
    val g = Add00(a, a).reverse(b)
    g(a).get.asInstanceOf[N0].eval[T0] shouldCloseTo b.toStd * 2.0
  }
