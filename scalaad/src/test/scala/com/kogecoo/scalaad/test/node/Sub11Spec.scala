...
object Sub11Spec extends Properties("Sub11") with NodeSpecBase {
  ...
  property("nonvar1 - var1 reverse node0") = forAll(genNV1_V1(), genN0()) { case ((a: N1, b: Var1), c: N0) =>
    val g = Sub11(a, b).reverse(c)
    g(b).get.asInstanceOf[N1].eval[T1] shouldCloseTo (one1(b).neg mul c.toStd)
  }
  ...
  property("var1 - var1 reverse node0") = forAll(genV1(), genN0()) { (a: Var1, b: N0) =>
    val g = Sub11(a, a).reverse(b)
    g(a).get.asInstanceOf[N1].eval[T1] shouldCloseTo zero1(a)
  }
